...
public struct DetailModel : Equatable, Identifiable, Hashable{
    public init(id: Int, name: String, released: String?, rating: Double, description: String?, background_image: String?, background_image_additional: String?, parent_platforms: [PlatformsModel], genres: [GenreModel], clip: String?) {
        self.id = id
        self.name = name
